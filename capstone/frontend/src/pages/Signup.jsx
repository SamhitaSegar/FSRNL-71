...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setServerError("");
    try {
      // Dispatches the register thunk: POST {VITE_API_URL}/auth/register.
      // unwrap() throws on a rejected thunk so we can surface the server
      // message. On success, send the user to the login page.
      await dispatch(
        register({
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join Foodie and start ordering in minutes."
    >
